...
function bkSubmit() {
  ...
  if (confirmBtn) { confirmBtn.disabled = true; confirmBtn.innerHTML = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="animation:spin .8s linear infinite;vertical-align:middle;margin-right:.4rem"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg> Sending…'; }
